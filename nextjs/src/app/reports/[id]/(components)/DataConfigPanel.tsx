...
import { Layers, RefreshCcw, Trash2, Users } from 'lucide-react'
...
export default function DataConfigPanel() {
  ...
  return (
    <Card className="bg-meepGray-800 border-1 text-meepGray-200 border border-meepGray-700 min-w-60 overflow-y-auto min-h-0">
                            ...
                            (!layer.sharingPermission ? (
                              <>
                                <div className="flex flex-row justify-between items-center border-b border-meepGray-700 pb-2">
                                  <div>
                                    {layer.source.importedDataCount || 0}{' '}
                                    records imported
                                  </div>
                                  <Button
                                ...
                                <Button
                                  onClick={() => {
                                    router.push(
                                      `/data-sources/inspect/${layer?.source?.id}`
                                    )
                                  }}
                                  className=""
                                >
