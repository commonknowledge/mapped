// This file contains the hex coordinates for UK constituencies
...
// Optional: Create a type for the hex data
export type UKHexData = typeof hexData
export type ConstituencyId = keyof typeof hexData.hexes
