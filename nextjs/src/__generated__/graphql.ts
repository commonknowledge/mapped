...
export type GetHubMapDataQuery = { __typename?: 'Query', hubByHostname?: { __typename?: 'HubHomepage', id: string, organisation: { __typename?: 'Organisation', id: string, slug: string, name: string }, layers: Array<{ __typename?: 'MapLayer', id: string, name: string, type: string, visible?: boolean | null, iconImage?: string | null, popup?: boolean | null, mapboxPaint?: any | null, mapboxLayout?: any | null, mapboxType?: string | null, source: { __typename?: 'SharedDataSource', id: any, dataType: DataSourceType } }>, navLinks: Array<{ __typename?: 'HubNavLink', label: string, link: string }> } | null };
